            ...
            },
            {
                ...
                "render": function (data, type, row, meta) {
                    ...
                    if (type === "display") {
                        ...
                        html += _renderButton(true, "EditStatus", "btn btn-lighter-primary mr-1 btn-a-outline-primary dropdown-item", "/Sys/Status/Edit/" + data, '<i class="far fa-edit text-primary text-120 mr-1"></i> Cập nhật', "Cập nhật");
