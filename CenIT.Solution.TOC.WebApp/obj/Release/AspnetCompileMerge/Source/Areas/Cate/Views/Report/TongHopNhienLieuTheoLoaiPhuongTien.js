var _ReportActionURLs = {
    Report_GetData: "/Cate/Report/TongHopNhienLieuTheoLoaiPhuongTien"
};
var _tableReport;
var fromDate;
var toDate;
...
function initTableReport() {
    _tableReport = $("#RPTongHopNhienLieuTheoLoaiPhuongTien").DataTable({
        "Responsive": true,
        "language": {
            "processing":
        ...
        "ajax":
        {
            "url": "/Cate/Report/TongHopNhienLieuTheoLoaiPhuongTien",
            "type": "POST",
            "Report": "JSON",
            "data": {
...
function ExportToExcel() {
    ...
    url += '?FromDate=' + tuNgay + '&ToDate=' + denNgay + '&type=TheoLoaiPhuongTien';
