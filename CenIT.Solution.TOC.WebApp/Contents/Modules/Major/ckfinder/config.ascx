...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        //Chỗ này nếu có username thì nên bỏ vô để bắt trường hợp có user mới cho upload hình
        // Ví dụ 
    ...
    public override void SetConfig()
    {
        ...
        LicenseKey = "5UT5WAR17E48NMBMUVTLT6LBTGE4B92H";

        // The base URL used to reach files in CKFinder through the browser.
        BaseUrl = "/Contents/imgs/news/";
        ...
        type.Url = BaseUrl;// + DateTime.Now.ToString("yyyyMM") + "/";
